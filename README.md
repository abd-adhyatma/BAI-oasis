![docker image](https://github.com/abd-adhyatma/BAI-oasis/actions/workflows/docker-publish.yml/badge.svg)


# abd-adhyatma's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of abd-adhyatma.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/abd-adhyatma/BAI-oasis.git
    cd BAI-oasis
    ```
    ...
    ```sh
    curl-L -o BAI-oasis.zip "https://github.com/abd-adhyatma/BAI-oasis/archive/main.zip"
    unzip BAI-oasis.zip
    cd BAI-oasis
    ```
...
your `docker-compose.yaml` with `ghcr.io/abd-adhyatma/bai-oasis:main` for the services
...
By default, no plugins are included in this distribution. You can find a list of available NOMAD plugins [here](https://nomad-lab.eu/prod/v1/oasis/gui/search/plugins). For a list of official plugins provided by FAIRmat, please see [here](https://github.com/abd-adhyatma/.github/blob/main/profile/README.md). For inspiration, you can also check the list of [plugins that are installed on the production NOMAD deployment hosted by FAIRmat](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-distro/-/raw/main/pyproject.toml?ref_type=heads).
...
```sh
docker pull ghcr.io/abd-adhyatma/bai-oasis/jupyter:main
```
...
By default, documentation is built using the [nomad-docs](https://github.com/abd-adhyatma/nomad-docs) repository. However, if you'd like to customize the documentation for your Oasis instance, you can easily do so.

1. First, [fork the nomad-docs repository](https://github.com/abd-adhyatma/nomad-docs/fork).
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/abd-adhyatma/BAI-oasis/manifests/main": unauthorized`
